    ...
    <table className={s.tableDiv}>
      <thead className={s.table__head}>
        <tr className={s.table__head__row}>
          ...
          <th colSpan="1" className={s.table__head__type}>
            Тип
          </th>
          <th colSpan="1" className={s.table__head__date}>
            Время
          </th>
          <th colSpan="1" className={s.table__head__avatar}>
            Сотрудник
          </th>
          <th colSpan="1" className={s.table__head__call}>
            Звонок
          </th>

          <th colSpan="1" className={s.table__head__source}>
            Источник
          </th>
          <th colSpan="1" className={s.table__head__score}>
            Оценка
          </th>

          <th colSpan="2" className={s.table__head__time}>
            Длительность
          </th>
        </tr>
      </thead>
